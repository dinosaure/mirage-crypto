let std_flags = [ "--std=c11"; "-Wall"; "-Wextra"; "-O3" ]
  ...
  let arch =
    let defines =
      Configurator.V1.C_define.import c ~includes:[]
        [
          ("__MIRAGE_CRYPTO_NO_ACCELERATE__", Switch);
          ("__x86_64__", Switch);
          ("__i386__", Switch);
    ...
    in
    match defines with
    | (_, Switch true) :: _ -> `none
    | _ :: (_, Switch true) :: _ -> `x86_64
    | _ :: _ :: (_, Switch true) :: _ -> `x86
    | _ :: _ :: _ :: (_, Switch true) :: _ -> `ppc64
    | _ :: _ :: _ :: _ :: (_, Switch true) :: _ -> `s390x
    | _ :: _ :: _ :: _ :: _ :: (_, Switch true) :: _ -> `arm64
    | _ :: _ :: _ :: _ :: _ :: _ :: (_, Switch true) :: _ -> `x86_64
    | _ :: _ :: _ :: _ :: _ :: _ :: _ :: (_, Switch true) :: _ -> `x86
    | _ -> `unknown
  in
  let os =
    let defines =
